      ...
      return {
        ...
        yourJSONDataFillThere: { // 用来展示的节点与连线
          nodes: [{
            ...
            "iconClassName": "el-icon-user",     /* 非必要  节点icon的类名 */
            "catogory": "person",
            "recommendFriend" : [],           
          },
          {
          ...
          },
          {
            ...
            "iconClassName": "el-icon-reading",     /* 非必要  节点icon的类名 */
            "nameDescribe": "气泡内容",           /* 非必要 气泡内容 */  
            "catogory": "primarySchool",             
          },
          {
            "id": 17,                             // 节点id
            "in_ports": [ 0 ],                   // 入口下标
          ...
          },
          {
            ...
            "iconClassName": "el-icon-office-building",     /* 非必要  节点icon的类名 */
            "nameDescribe": "气泡内容",           /* 非必要 气泡内容 */  
            "catogory": "middleSchool",         
          },
          {
          ...
          },
          {
            ...
            "iconClassName": "el-icon-star-off",     /* 非必要  节点icon的类名 */
            "nameDescribe": "气泡内容",           /* 非必要 气泡内容 */  
            "catogory": "middleSchool",       
          },
           {
